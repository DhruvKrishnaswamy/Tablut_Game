...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("About", this::about);
     ...
     * @param dumb : Not used*/
    private void help(String dumb) {
        displayText("Tablut Help for your soul", HELP_TEXT);
    }

    /** Response to "about" button click.
     * @param notused : Not used */
    private void about(String notused) {
        displayText("About the Game Tablut", ABOUT_TEXT);
    }
